...
kurs_link: https://app.decaid.academy/ai-starterter
tags:
  - lernen
  - weiterbildung
erstellt: 2026-02-13
...
>  In diesem Lernpfad baust du eine fundierte Grundlage im Umgang mit Generative AI auf – technisch, strategisch und praktisch.
>  
>  Du lernst zentrale Tools, Methoden und Denkweisen kennen, um Chatbots, KI-Assistenten, Bild- und Videogenerierung sowie modernes Prompting souverän im Berufsalltag einzusetzen. Ideal als Einstieg in die GenAI-Welt – für jede Rolle.

## 📂 Kurs-Materialien

### Was erwartet dich in diesem Lernpfad?

Du bekommst einen klaren Überblick über die wichtigsten GenAI-Konzepte und lernst, wie du Tools wie ChatGPT, Midjourney, Claude, Pika, Langdock & Co. in der Praxis einsetzt.

Mit Übungen, Templates und Use Cases startest du deinen KI-Workflow – direkt anwendbar, sicher und kreativ.

#### Für wen eignet sich dieser Kurs?

Dieser Lernpfad richtet sich an Einsteiger:innen, Wissensarbeiter:innen, Kreative und Digital Professionals,

die sich schnell und praxisnah mit den Grundlagen von GenAI vertraut machen und sie sicher, kreativ und effizient in ihren Arbeitskontext integrieren möchten – unabhängig von Fachbereich oder Branche.

#### Was lernst du in diesem Kurs?

Du lernst:

🧠 wie Generative AI funktioniert – von LLMs bis Diffusion Models,

🗣️ wie du mit Chatbots und KI-Assistenten Aufgaben effizienter löst,

🎨 wie du eigene Visuals & Videos mit AI-Tools erzeugst,

🧩 wie du durch Context Management & Prompting bessere Ergebnisse erzielst.
...
### Grundlagen in der Nutzung von KI-Chatbots (ChatGPT, Claude, Perplexity, Gemini, Copilot, Langdock)
