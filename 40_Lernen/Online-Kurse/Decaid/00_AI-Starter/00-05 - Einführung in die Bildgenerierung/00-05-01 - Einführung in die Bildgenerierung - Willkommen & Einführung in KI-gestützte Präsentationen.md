...
- **Produktentwicklung:** Visualisierung von Prototypen, Designvarianten.
- **Unterhaltung:** Game-Assets, Story-Visualisierung.
- **Bildung:** Erstellung von Lehrmaterialien, Illustrationen.
...
- **Open Source:** Unendliche Möglichkeiten.
- **Modellvielfalt:** Welche Anbieter gibt es noch?.
- **Automation:** Bilder am Fließband.
 ----
## Einführung in die Bildgenerierung - Grundlagen 03:30

Hier ist der extrahierte Text aus den neu hochgeladenen Bildern, für Markdown formatiert:
...
- **Weitere:** Inpainting (Teile ersetzen), Outpainting (Bild erweitern), Style Transfer.
...
- **Schritt 3: Denoising:** Dein Text (Prompt) leitet diesen Denoising-Prozess, um das gewünschte Bild zu formen.
...
## Slidedeck Einführung in die Bildgenerierung
[[00-05-01_1-DE_Bildgenerierung.pptx]]
